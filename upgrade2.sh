...
cd /app-data/miners 
rm -f H9-Miner-spacemesh-v4.0.0-4-linux.zip && rm -rf linux
wget https://github.com/h9-dev/spacemesh-miner/releases/download/v4.0.0/H9-Miner-spacemesh-v4.0.0-4-linux.zip 
unzip H9-Miner-spacemesh-v4.0.0-4-linux.zip 
rm -f killh9.sh 
